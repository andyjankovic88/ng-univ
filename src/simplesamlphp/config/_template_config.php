...
$config = array (
	 ...
	 * reverse proxy).
	 */
	'baseurlpath'           => 'https://@server.prefix@@server.name@/simplesaml/',
	'certdir'               => 'cert/@server.context@/', //see cert/readme.php
	'loggingdir'            => '@log.base.dir@',
	'datadir'               => 'data/',
	 ...
	 */
	'debug' => @server.displayerrors@,


	'showerrors'            =>	@server.displayerrors@,
	 ...
	 */
	'auth.adminpassword'		=> 'thefollowing!#%&(',
	...
	'technicalcontact_email'    => 'team@ucroo.com',
  ...
  'logging.handler'       => 'file',
	...
	'memcache_store.servers' => array(
		array(
			array('hostname' => '@memcached.server@'),
		),
	),
