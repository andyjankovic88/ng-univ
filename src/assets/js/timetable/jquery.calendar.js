...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        ...
        function quickadd(start, end, isallday, pos) {
            ...
            startDate = dateFormat.call(start, i18n.xgcalendar.dateformat.fulldayvalue + "_HH:mm").replace("/","-").replace("/","-");
            endDate = dateFormat.call(end, i18n.xgcalendar.dateformat.fulldayvalue + "_HH:mm").replace("/","-").replace("/","-");
            
            var url="/timetable/edit?start="+startDate+"&end="+endDate+"&isallday="+(isallday?"1":"0")+"&id="; 
