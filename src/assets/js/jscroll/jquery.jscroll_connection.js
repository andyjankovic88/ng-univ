        ...
        function _load() {
            ...
            return $e.animate({scrollTop: $inner.outerHeight()}, 0, function() {
                ...
                $.ajax({
                        ...
                        cache: false,
                         beforeSend: function() {
                          $("#loading_connections_scroll").show();
                        },
                        success: function (data2) {
                            $("#loading_connections_scroll").hide();
                            $('#posting_suggestions').remove();
                            $(".jscroll-inner").last().append(data2);
                            var $next = $('.jscroll-inner').find(_options.nextSelector).last();
                            data.waiting = false;
