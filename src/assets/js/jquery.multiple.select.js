...
(function($) {
	...
	function MultipleSelect($el, options) {
		...
		elWidth = parseInt(elWidth) + parseInt(120); // ADDED EXTRA 120PX 
	...
	MultipleSelect.prototype = {
		...
		update: function() {
			...
			// Nirav : #4474 : 16-04-2014
                //18/08/15 - #5152 - Jaymit - Make changes to get code working that was commented long before by nirav and implemented new option of showSelectedOptionText
                if (this.options.showSelectedOptionText) {
                    if (selects.length) {
	...
	$.fn.multipleSelect.defaults = {
        ...
        showSelectedOptionText: false, //18/08/15 - #5152 - Jaymit - Implemented new option of showSelectedOptionText in heading optional show only when passed true.
		multiple: false,
		multipleWidth: 80,
		filter: false,
		width: undefined,
