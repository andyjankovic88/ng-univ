...
angular.module('ui.calendar', [])
  ...
  .controller('uiCalendarCtrl', ['$scope', 
      ...
      this.changeWatcher = function(arraySource, tokenFn) {
        ...
        // @example
        //  subtractassets_new([6, 100, 4, 5], [4, 5, 7]) // [6, 100]
        var subtractassets_new = function(a, b) {
          var result = [], inB = {}, i, n;
        ...
        var applyChanges = function(newTokens, oldTokens) {
          var i, n, el, token;
          var replacedTokens = {};
          var removedTokens = subtractassets_new(oldTokens, newTokens);
          ...
          var addedTokens = subtractassets_new(newTokens, oldTokens);
