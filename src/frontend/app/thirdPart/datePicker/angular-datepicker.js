  ...
  return {
    ...
    link: function (scope, element, attrs, ngModel) {
      ...
      var arrowClick = false,
        ...
        minDate = scope.min,//getDate('minDate'),
        ...
        if (view === 'date') {
          ...
          for (i = 0; i < weeks.length; i++) {
            ...
            for (j = 0; j < week.length; j++) {
              ...
              if (scope.start && scope.start.isBefore(week[j]) && scope.end.isAfter(week[j])) {
                classList += ' active-range';
              }
              if (datePickerUtils.isSameDay(scope.start, week[j])) {
                classList += ' active-start';
              }
              if (datePickerUtils.isSameDay(scope.end, week[j])) {
                classList += ' active-end';
              }
...
$templateCache.put('templates/datepicker.html',
    ...
    "      <tr>\r" +
    "\n" +
    "        <th ng-click=\"prev()\"><svg class=\"ico-left l-side\"><use xmlns:xlink=\"http://www.w3.org/1999/xlink\" xlink:href=\"#icon-chevron-left\"></use></svg></th>\r" +
    "\n" +
    "        <th colspan=\"5\" class=\"switch\" ng-click=\"setView('month')\" ng-bind=\"date|mFormat:'YYYY MMMM':tz\"></th>\r" +
    "\n" +
    "        <th ng-click=\"next()\"><svg class=\"ico-left r-side\"><use xmlns:xlink=\"http://www.w3.org/1999/xlink\" xlink:href=\"#icon-chevron-right\"></use></svg></th>\r" +
    "\n" +
    "      </tr>\r" +
    "\n" +
    "      <tr>\r" +
    "\n" +
    "        <th class=\"weekdays\" ng-repeat=\"day in weekdays\" style=\"overflow: hidden\" ng-bind=\"day|mFormat:'dd':tz\"></th>\r" +
    "\n" +
    "      </tr>\r" +
    "\n" +
    "      </thead>\r" +
    ...
    "\n" +
    "            ng-click=\"selectDate(day); $event.stopPropagation();\" ng-bind=\"day|mFormat:'DD':tz\"></span>\r" +
    "\n" +
    "        </td>\r" +
    "\n" +
    "      </tr>\r" +
