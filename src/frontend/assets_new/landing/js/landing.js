...
// @fileRef jquery-ui-1.8.22.custom.min.js
...
// @fileRef jquery.autogrow-textarea.js
...
// @fileRef jquery.limitMaxlength.js
...
// @fileRef jquery.placeholder.min.js
...
// @fileRef jquery.mousewheel-3.0.6.pack.js
   ...
   // validate signup form on keyup and submit
    $("#request-demo").validate({
      ...
      submitHandler: function(form) {
        $('#loading_image').html('<img src="/assets_new/landing/images/loading-boring.gif" class="request-msg-icon"/> <span class="request-msg">Sending your request.</span>');
...
// @fileRef jquery.dataTables.js

/*! DataTables 1.10.4
 * Г‚В©2008-2014 SpryMedia Ltd - datatables.net/license
 */
...
// @fileRef jquery.tablesorter.min.js
...
// @fileRef jquery.ui.messagebox.js
...
// @fileRef jquery.multiselect.min.js
...
// @fileRef jquery.multiselect.filter.min.js
...
// @fileRef jquery.expander.min.js
...
(function() {
	var csstype = 'external', // specify type of CSS to use. "inline" or "external"
		...
		mac_externalcss = '//' + document.location.host + '/assets_new/landing/css/macstyle.css', // if "external", specify Mac css file here
		pc_externalcss = '//' + document.location.host + '/assets_new/landing/css/windowstyle.css', // if "external", specify PC/default css file here
...
mixpanel.init("694bb81ac0dfe5749ccf9ce901fc9a48");
// end Mixpanel
